...
import { n as stegaClean, t as isRecord } from "./stegaClean-x8apbTR3.js";
...
//#endregion
//#region node_modules/@sanity/client/dist/_chunks-es/resolveEditInfo.js
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
	...
	return stega.enabled ? $request.pipe(combineLatestWith(from(import("./stegaEncodeSourceMap-DAOJeRn5.js").then(function(n) {
...
var pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), eventSourcePolyfill = defer(() => import("./browser-CEeDQXAj.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).pipe(map(({ default: EventSource2 }) => EventSource2), shareReplay(1));
